...
function Autocomplete({options, value, onChange, multiple=false}){
  ...
  const processMultipleInput = (event, newValue)=>{
  ...
  return(
    <MuiAutocomplete
      ...
      renderInput={(params) => <TextField {...params} label="Query" variant="outlined" />}
